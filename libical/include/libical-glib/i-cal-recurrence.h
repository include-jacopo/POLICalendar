...
LIBICAL_ICAL_EXPORT
G_DECLARE_DERIVABLE_TYPE(ICalRecurrence, i_cal_recurrence, I_CAL, RECURRENCE, ICalObject)
...
LIBICAL_ICAL_EXPORT
gshort 		i_cal_recurrence_encode_day	(ICalRecurrenceWeekday weekday,
						 gint position);
...
LIBICAL_ICAL_EXPORT
gshort 		i_cal_recurrence_encode_month	(gint month,
						 gboolean is_leap);
